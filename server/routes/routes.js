...
router.get('/vinho', function (req, res) {
    ...
    con.query('select * from vinho ORDER BY Rating DESC', function (error, rows, fields) {
        if (error) console.log(error);
        else {
            res.send(rows);
        }
...
router.post('/userIds', function (req, res) {
    ...
    con.query('select Utilizadorid from Utilizadores where email =?', sqlParams, function (error, rows, fields) {
...
router.post('/reviews', function (req, res) {
    ...
    var query = "INSERT INTO review ( descricaoReview , Utilizadorid, reviewRating, IDVinho) VALUES ? "
...
router.post('/inserirProducao', function (req, res) {
    ...
    var query = "INSERT INTO producao ( NomeProducao , IDVinho, Utilizadorid) VALUES ? "
    let values = [
        [NomeProducao, IDVinho, ID],
    ];
...
router.get('/producao', function (req, res) {
    ...
    con.query('select * from producao where Utilizadorid= ?', sqlParams, function (error, rows, fields) {
