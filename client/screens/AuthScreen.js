...
sendIds = async (params) => {
    ...
    await axios.post(`${API_URL}/userIds`, { params })
        .then((response) => {
...
module.exports = AuthScreen = (props: AuthScreenProps) => {
    ...
    return (
        <ImageBackground source={require('../assets/annie-spratt-im8y4BO2hso-unsplash.jpg')} style={styles.image}>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.form}>
                    <View style={styles.inputs}>
                        <TextInput style={styles.input} placeholder="Username" autoCapitalize="none" onChangeText={setEmail}></TextInput>
